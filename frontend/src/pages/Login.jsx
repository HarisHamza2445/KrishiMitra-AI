    ...
    return (
        <div className="min-h-screen flex bg-white">
            <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1464226184884-fa280b87c399?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay"></div>
                ...
                <div className="relative z-10 max-w-lg px-12">
                    ...
                    <h1 className="text-4xl font-extrabold text-white mb-6 leading-tight">
                        Welcome back to <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-300">KrishiMitra AI.</span>
                    </h1>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative">
                ...
                >
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-slate-500 mt-2">Manage your harvest with AI. 👋</p>
                    </div>
                    ...
                    {successMessage && (
                        <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-600 text-sm font-medium flex items-center gap-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3.5 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl shadow-lg shadow-slate-900/20 transition-all transform hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2 disabled:opacity-70"
                        >
                    ...
                    <p className="text-center text-slate-500 font-medium mt-8">
                        Don't have an account? <Link to="/register" className="text-emerald-600 font-bold hover:text-emerald-700">Register</Link>
                    </p>
                </motion.div>
            </div>
        </div>
